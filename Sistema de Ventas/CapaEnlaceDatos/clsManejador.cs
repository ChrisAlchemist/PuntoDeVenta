...
namespace CapaEnlaceDatos
{
    public class clsManejador
    {
        ...
        //Server=cmv8030;Database=Hape;User Id=sa_temp;Password=Abcde1
        public SqlConnection conexion = new SqlConnection("Server=cmv8030;DataBase=DemoPractica;User Id=sa_temp;Password=Abcde1");
